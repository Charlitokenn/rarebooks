import{u as L}from"./OptionsContext-ZIDUT1-3.js";import{u as U}from"./EnvironmentContext-CInYJpkG.js";import{InternalThemeProvider as V}from"./index-BXcNRXjB.js";import{F as g,e as o}from"./index-CANJaUYN.js";import{M as D}from"./Modal-Dp96EO7X.js";import{P as Z}from"./Portal-C3Yaa8Mk.js";import{b as d,P as K,a as Y,C as q}from"./shared-gVVqeryn.js";import{j as e,e as N,r as c,b as i,F as m,R as W,i as H}from"./index-9vi_ri4-.js";import"./underscore-PzdM3hke.js";import"./AppearanceContext-uMPH6V3Y.js";import"./utils-V2FbmPWk-CO7FM5J0.js";import"./makeLocalizable-DQWTS7aA.js";import"./localizationKeys-L95TEc06.js";import"./makeCustomizable-BY14huWe.js";import"./url-jVki8Rol.js";import"./floating-ui.react-BoOk-f8c.js";import"./index-Uz0I88EY.js";import"./index-N2II4Ryk.js";import"./useScrollLock-BfxNPW2e.js";import"./index-Bt6prZXF.js";import"./RouteContext-Db5iCvKh.js";const J="https://dashboard.clerk.com/~/organizations-settings",Q=({caller:t,onSuccess:a,onClose:s})=>{const r=N(),[p,h]=c.useState(!1),[l,u]=c.useState(!1),[f,A]=c.useState(null),[v,B]=c.useState(!1),k=c.useRef(null),w=U(),$=c.useId(),_=L(),b=_.__internal_keyless_claimKeylessApplicationUrl,M=_.__internal_keyless_copyInstanceKeysUrl,j=!!b&&!!M,G=w.authConfig.claimedAt!==null,y=l&&j&&!G,T=!t.startsWith("use"),I=typeof w?.organizationSettings.forceOrganizationSelection<"u",F=()=>{h(!0);const n={enable_organizations:!0};I&&(n.organization_allow_personal_accounts=v),w.__internal_enableEnvironmentSetting(n).then(async()=>{A((await r.user?.getOrganizationMemberships())?.data[0]?.organization.name??null),u(!0),h(!1)}).catch(()=>{h(!1)})};return e(Z,{children:e(D,{canCloseModal:!1,containerSx:()=>({alignItems:"center"}),initialFocusRef:k,children:i(K,{sx:()=>({display:"flex",flexDirection:"column",width:"30rem",maxWidth:"calc(100vw - 2rem)"}),children:[i(g,{direction:"col",sx:n=>({padding:`${n.sizes.$4} ${n.sizes.$6}`,paddingBottom:n.sizes.$4,gap:n.sizes.$2}),children:[i(g,{as:"header",align:"center",sx:n=>({gap:n.sizes.$2}),children:[e(re,{isEnabled:l}),e("h1",{css:[d,o`
                    color: white;
                    font-size: 0.875rem;
                    font-weight: 500;
                    outline: none;
